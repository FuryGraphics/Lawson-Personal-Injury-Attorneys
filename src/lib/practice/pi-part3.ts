...
export const bicycleAccidents: PracticePage = {
  ...
  h1: 'Lawrenceville Bicycle Accident Lawyer',
  targetKeyword: 'Bicycle Accident Lawyer Lawrenceville GA',
  metaTitle: 'Bicycle Accident Lawyer Lawrenceville GA',
  metaDescription:
    'Hit while cycling in Lawrenceville? We handle Georgia bicycle accident claims and push back on driver-blame defenses. Free case review — call (678) 446-3655.',
  label: 'Case type',
...
export const busAccidents: PracticePage = {
  ...
  group: 'Motor Vehicle Accidents',
  h1: 'Lawrenceville Bus Accident Lawyer',
...
export const uberAccidents: PracticePage = {
  ...
  group: 'Motor Vehicle Accidents',
  h1: 'Lawrenceville Uber Accident Lawyer',
  targetKeyword: 'Uber Accident Lawyer Lawrenceville GA',
  metaTitle: 'Uber Accident Lawyer Lawrenceville GA',
  metaDescription:
    'Injured in an Uber in Lawrenceville? Coverage depends on the app status at impact. We find the policy that applies. Free review — call (678) 446-3655 today.',
  label: 'Case type',
...
export const lyftAccidents: PracticePage = {
  ...
  group: 'Motor Vehicle Accidents',
  h1: 'Lawrenceville Lyft Accident Lawyer',
  targetKeyword: 'Lyft Accident Lawyer Lawrenceville GA',
  metaTitle: 'Lyft Accident Lawyer Lawrenceville GA',
  metaDescription:
    'Hurt in a Lyft in Lawrenceville? Which policy pays depends on the app status at impact, and we establish it with trip data. Free review — (678) 446-3655 today.',
  label: 'Case type',
...
export const taxiAccidents: PracticePage = {
  ...
  group: 'Motor Vehicle Accidents',
  h1: 'Lawrenceville Taxi Accident Lawyer',
  targetKeyword: 'Taxi Accident Lawyer Lawrenceville GA',
  metaTitle: 'Taxi Accident Lawyer Lawrenceville GA',
  metaDescription:
    'Injured in a taxi in Lawrenceville? Cabs are common carriers owing their passengers a heightened duty of care. Free case review today — call (678) 446-3655.',
  label: 'Case type',
