...
export const premisesLiability: PracticePage = {
  ...
  metaDescription:
    'Hurt on unsafe property in Atlanta? Georgia premises claims turn on what the owner knew and ignored. Free review, no fee unless we win — (678) 446-3655.',
  label: 'Case type',
...
export const workplaceAccidents: PracticePage = {
  ...
  navLabel: 'Workplace Injuries',
  group: 'Premises, Property & Workplace',
  h1: 'Atlanta Workplace Injury Lawyer',
  targetKeyword: 'Workplace Injury Lawyer Atlanta GA',
  metaTitle: 'Workplace Injury Lawyer Atlanta GA',
  metaDescription:
  ...
  cardBlurb:
    'Third-party claims for people seriously injured at work by someone other than their employer.',
  intro: [
    'This firm does not handle workers’ compensation claims. What it does handle is the claim that frequently exists alongside one — and that most injured workers never hear about.',
    'Workers’ compensation is a claim against your own employer, and in Georgia it is an exclusive remedy: you receive medical treatment and a portion of your wages without proving fault, and in exchange you generally cannot sue your employer. It pays nothing for pain and suffering, and nothing for the full extent of a permanently diminished career.',
    'None of that bars a claim against someone else. If a driver from another company hit you while you were working, if a contractor on the site created the hazard, if the property owner let a dangerous condition stand, or if a machine failed because it was built without a guard, that party is an ordinary defendant in an ordinary negligence case — with the full range of damages available. For a worker facing a permanent injury, that third-party claim is usually where meaningful compensation comes from. We will look at whether one exists, and tell you plainly if it does not.',
  ],
  handles: [
    { title: 'Struck by another company’s driver', body: 'Injured in a collision while working — a claim against the at-fault driver and their employer, entirely separate from any comp claim.' },
    { title: 'Hazards created by another contractor', body: 'Where a different company on the site created the condition that hurt you.' },
    ...
    { title: 'Defective or unguarded machinery', body: 'Claims against the manufacturer of equipment that failed or shipped without an adequate safety guard.' },
    { title: 'Falls at work on third-party premises', body: 'From height or on the same level, where the property owner or occupier was on notice of the hazard.' },
    { title: 'Warehouse and loading dock incidents', body: 'Forklift and vehicle injuries in facilities operated by someone other than your employer.' },
    { title: 'Negligent security at a workplace', body: 'Assaults on a property whose owner knew violence was foreseeable and provided nothing.' },
    { title: 'Catastrophic and fatal workplace injuries', body: 'Permanent injuries and wrongful death claims, where the third-party case is often the only meaningful recovery.' },
  ],
  georgiaNote: {
    heading: 'What the exclusive remedy rule does and does not bar',
    body: [
      'Georgia workers’ compensation is an exclusive remedy against your employer. You do not have to prove your employer did anything wrong, and in exchange you generally cannot sue them in tort. That trade-off is why comp pays medical treatment and roughly two-thirds of lost wages, and nothing at all for pain and suffering.',
      'The exclusivity stops at the employer. A negligence claim against anyone else — another contractor, an equipment manufacturer, a property owner, a driver who hit you on the job — is not barred, and it carries the full range of damages: pain and suffering, loss of enjoyment of life, and the whole of diminished earning capacity.',
      'The two run on different clocks. A third-party negligence claim follows Georgia’s ordinary two-year deadline (O.C.G.A. § 9-3-33). If you are also pursuing a workers’ compensation claim through another firm or on your own, note that the comp insurer will typically assert a lien against any third-party recovery — so the two need to be coordinated even though we are only handling one of them.',
    ],
  },
  process: [
    { title: 'Free case review', body: 'What happened, who you work for, and — the question that matters most here — who else was involved.' },
    { title: 'Finding the third party', body: 'Identifying every non-employer whose conduct contributed, from equipment makers to other contractors to property owners.' },
    { title: 'Building the negligence case', body: 'Site records, safety and OSHA documentation, equipment history, and witness accounts.' },
    { title: 'Demand or suit', body: 'A demand covering the full harm, and suit within the two-year deadline if the offer does not reflect it.' },
  ],
  faqs: [
    { q: 'Do you handle workers’ compensation claims?', a: 'No. This firm does not take workers\' compensation cases. What we look at is whether a separate claim exists against someone other than your employer — which is a different kind of case, and one that comp does not bar. If your only claim is against your employer, we will tell you that and point you toward a firm that does comp work.' },
    { q: 'What is a third-party claim?', a: 'A negligence claim against anyone other than your employer who contributed to the injury: another contractor on the site, an equipment manufacturer, a property owner, or a driver who hit you while you were working. It is an ordinary personal injury case, and it covers pain and suffering and full lost earning capacity — which workers\' compensation does not.' },
    { q: 'Can I bring both?', a: 'Yes, and they proceed independently. Workers\' compensation covers the employment side regardless of fault; the third-party claim goes after whoever actually caused the harm. The comp insurer will usually assert a lien against any third-party recovery, so how and when each resolves affects what you keep.' },
    { q: 'How do I know whether a third party was involved?', a: 'Often you do not, which is exactly why the question is worth asking. It turns on details most injured workers have no reason to notice — who owned the equipment, which company created the hazard, who controlled the property, whether a machine shipped with the guard it should have had. That is what an early case review is for.' },
    { q: 'Will making a claim cost me my job?', a: 'A third-party claim is against another company, not your employer, so it does not put you in conflict with them the way people fear. Georgia also makes retaliation for pursuing a workers\' compensation claim unlawful. The concern is understandable, and it is worth talking through rather than leaving a serious injury uncompensated.' },
    { q: 'Does my immigration status matter?', a: 'No. Immigration status does not bar a personal injury claim in Georgia, and consultations are confidential. This is a common fear that keeps injured people from pursuing claims they are fully entitled to bring.' },
  ],
  related: ['premises-liability', 'catastrophic-injuries', 'car-accidents'],
};
