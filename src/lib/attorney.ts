...
export const attorneyProfile = {
  ...
  bio: [
    'Lawson Personal Injury Attorneys exists to do one thing: represent people who have been hurt by someone else’s carelessness. That covers vehicle collisions, unsafe and unsecured property, and injuries at work caused by someone other than an employer — with the firm’s weight behind the catastrophic injury and wrongful death cases where the stakes for a family are highest. That focus is a practical decision rather than a marketing one. Insurance defense strategies repeat, adjusters behave in patterns, and Georgia’s courts have their own rhythms. Seeing the same terrain every day is what lets a small firm meet a large insurer on level ground.',
